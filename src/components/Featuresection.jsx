...
const Featuresection = () => {
  return (
    <>
      <div className="feature-section flex flex-col bg-cyan-300 justify-center items-center box-border pt-2 ">
        ...
        <div className="feature-cards flex flex-wrap w-[95%] md:w-[90%] lg:w-[85%] justify-center items-center">
          {featuresData.features.map((feature) => (
            <div key={feature.name} className="feature bg-cyan-200 relative flex flex-col h-[350px] w-[350px] m-8 justify-center items-center border-white border-2 border-solid rounded-xl px-4 hover:border-transition transition-colors duration-2000 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:bg-gradient-to-br from-cyan-500 via-cyan-400 to-cyan-300 cursor-pointer">
